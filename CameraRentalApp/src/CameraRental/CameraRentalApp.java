...
class Camera {
 ...
 public Camera(String cameraId, String brand, String model, double perDayPrice, boolean
isAvailable) {
...
public class CameraRentalApp {
 ...
 users.put("Tamalika", new User("Tamalika", "Tam123", 1000.0));
 users.put("user2", new User("user2", "password2", 200.0));
 }
 private static void initializeCameras() {
 cameras.add(new Camera("C1", "Canon", "Model X", 1000.0, true));
 cameras.add(new Camera("C2", "Nikon", "Model Y", 1500.0, true));
 cameras.add(new Camera("C3", "Sony", "Model Z", 1200.0, false));
 }
...
System.out.println("\n====================================================================================");
 System.out.format("%-10s %-10s %-15s %-15s %s\n", "Camera ID", "Brand", "Model", "Per DayPrice", "Status");
...
System.out.println("=====================================================================================");
 ...
 System.out.println("Wallet balance updated. Current balance: $" +
